...
class DAQ(Process):
    def run(self) -> int:
        self.process = subprocess.Popen(["hashpipe", "-p", "hashpipe", "-I", "0", "-o",
        "BINDHOST=\"0.0.0.0\"", "-o", "MAXFILESIZE=500", "-o", "SAVELOC=./", "-o",
        "CONFIG=./module.config", "net_thread", "compute_thread",  "output_thread"], shell=False, stdout=subprocess.PIPE)
