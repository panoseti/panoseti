...
def hashpipe_io_data_DEBUG(
    ...
    logger.info(f"Created a new DEBUG hashpipe_io thread with the following options: {kwargs=}")
    ...
    try:
        ...
        logger.info("hashpipe_io thread connected to the target F9t chip. The f9t io channel is now valid")
        valid.set()
