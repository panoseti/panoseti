...
- UX: the pseti xfr command has no progress bar. There’s also no resolved path for the ledgers, making it hard to manually inspect logs. (how to add this without making it cramped?
...
- The transfer queue tail command is broken:
    - root@panoseti-headnode-ucb:/app# pseti xfr  tail
