...
from ci.shared.qa_models import QAConfig, SuiteConfig, EnvironmentConfig
...
CONTROL_ROOT = Path(__file__).parent.parent.parent.resolve()
QA_TOML_PATH = Path(__file__).parent / "qa.sw.toml"
