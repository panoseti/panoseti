...
class TestRunStateLedgerExtendedStatuses:
    ...
    def test_new_status_recording_ended(self):
    ...
    def test_new_statuses_accepted(self, status):
    ...
    def test_legacy_status_still_loads(self):
...
class TestRunStateLedgerNewFields:
    ...
    def test_new_ledger_fields_transfer_attempts(self):
    ...
    def test_last_transfer_error_default_is_none(self):
        """Default value for last_transfer_error must be None."""
        ledger = RunStateLedger(**self._base())
        assert ledger.last_transfer_error is None

    def test_new_ledger_fields_manifest_algorithm(self):
    ...
    def test_manifest_algorithm_default_is_none(self):
        """Default value for manifest_algorithm must be None."""
        ledger = RunStateLedger(**self._base())
        assert ledger.manifest_algorithm is None

    def test_new_ledger_fields_next_action_not_before(self):
...
class TestNodeReceiptNewFields:
    ...
    def test_node_receipt_new_fields(self):
    ...
    def test_node_receipt_new_fields_default_none(self):
...
class TestTransitionHelper:
    ...
    def test_transition_helper_changes_status(self, tmp_path):
    ...
    def test_transition_helper_persists_to_disk(self, tmp_path):
    ...
    def test_transition_helper_accepts_extra_fields(self, tmp_path):
    ...
    def test_transition_helper_returns_none_when_no_state(self, tmp_path):
