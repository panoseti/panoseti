...
class TestGetCastedRedisValue:
    def test_positive_integer(self, r):
...
class TestGetUpdatedRedisKeys:
    ...
    def test_all_new_keys_returned_when_no_timestamps(self, r):
    ...
    def test_empty_db_returns_empty_list(self, r):
        keys = get_updated_redis_keys(r, {})
        assert keys == []

    def test_partial_update(self, r):
