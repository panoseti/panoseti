...
from utils import panoseti_interface
from utils.panoseti_interface import PanosetiRun, PFFSequence, get_precise_time_ns
...
def test_get_precise_time_ns_sync():
...
def test_get_precise_time_ns_daq_ahead():
    # DAQ is 1s ahead: d=1
    tv_sec = 1000
...
def test_get_precise_time_ns_daq_behind():
...
class TestPFFSequence:
    ...
    def test_init_and_analyze(self, img16_file):
    ...
    def test_get_frame(self, img16_file):
        seq = PFFSequence([img16_file])
    ...
    def test_index_timestamps(self, img16_file):
        seq = PFFSequence([img16_file])
    ...
    def test_seek_time(self, img16_file):
        seq = PFFSequence([img16_file])
        # Force indexing
        seq.index_timestamps()
    ...
    def test_get_image_array(self, img16_file):
        seq = PFFSequence([img16_file])
...
class TestPanosetiRun:
    ...
    def test_run_loading(self, run_dir):
