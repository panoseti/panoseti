...
class TestBoardLocMath:
    ...
    def test_module_id_simple_ip(self):
    ...
    def test_module_id_palomar_range(self):
    ...
    def test_four_consecutive_ips_share_module_id(self):
    ...
    def test_boardloc_round_trip(self):
    ...
    def test_boardloc_fits_uint16(self):
...
class TestHousekeepingPacketParsing:
    ...
    def test_temp1_at_array17_positive(self):
    ...
    def test_uid_all_zeros(self):
        pkt = _make_hk_packet(uid=(0, 0, 0, 0))
        for i in range(4):
            assert _parse_hk_field(pkt, 21 + i) == 0

    def test_uid_bytes_at_correct_offsets(self):
    ...
    def test_pcbrev_qfp_is_zero(self):
        pkt = _make_hk_packet(status_pcbrev=0x0000)
        raw = _parse_hk_field(pkt, 25)
        assert (raw >> 8) & 0x01 == 0

    def test_status_and_pcbrev_independent(self):
...
class TestHvSetMath:
    ...
    def test_all_four_channels_independent(self, quabo_and_sock):
    ...
    def test_zero_voltage(self, quabo_and_sock):
...
class TestAcqModeBitmask:
    ...
    def test_all_modes_off_byte_is_zero(self, quabo_and_sock):
    ...
    def test_image_ph_8bit_all_set(self, quabo_and_sock):
    ...
    def test_no_baseline_subtract_bit_when_disabled(self, quabo_and_sock):
    ...
    def test_integration_time_10000us(self, quabo_and_sock):
    ...
    def test_integration_time_zero(self, quabo_and_sock):
    ...
    def test_integration_time_max_uint16(self, quabo_and_sock):
...
class TestMarocPacketStructure:
    ...
    def test_opcode_is_0x01(self, quabo_and_sock):
        q, sock = quabo_and_sock
        q.send_maroc_params(_minimal_maroc_config())
        assert sock.last_cmd[0] == 0x01

    def test_serial_command_length_constant(self):
    ...
    def test_gap_bytes_are_zero_with_zero_config(self, quabo_and_sock):
    ...
    def test_destination_port(self, quabo_and_sock):
...
class TestTriggerMaskMultiChannel:
    ...
    def test_all_channels_enabled(self, quabo_and_sock):
    ...
    def test_single_channel_no_aliasing(self, quabo_and_sock):
    ...
    def test_last_channel_chanmask8(self, quabo_and_sock):
    ...
    def test_all_distinct_values(self, quabo_and_sock):
    ...
    def test_opcode_and_length(self, quabo_and_sock):
        q, sock = quabo_and_sock
