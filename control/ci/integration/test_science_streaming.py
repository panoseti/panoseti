...
class TestScienceStreamingSimulation:
    ...
    def test_ping(self, daq_data_client, ensure_clean_daq_state):
    ...
    def test_init_sim(self, daq_data_client, ensure_clean_daq_state):
        """init_sim() succeeds — server configures itself to stream from bundled PFF."""
        ok = daq_data_client.init_sim(hosts=None)
        assert ok is True

    def test_stream_delivers_frames(self, daq_data_client, ensure_clean_daq_state):
    ...
    def test_frame_is_dict(self, daq_data_client, ensure_clean_daq_state):
    ...
    def test_double_init_sim_succeeds(self, daq_data_client, ensure_clean_daq_state):
