...
@skip_outside_ci
def test_transfer_daemon_archives_run(tmp_path):
    """
...
@skip_outside_ci
def test_transfer_daemon_resumes_after_crash(tmp_path):
    """
...
@skip_outside_ci
def test_transfer_daemon_retry_on_transient_rsync_failure(tmp_path):
    """
...
@skip_outside_ci
def test_transfer_daemon_marks_failed_after_max_attempts(tmp_path):
    """
...
@skip_outside_ci
def test_transfer_daemon_singleton_lock_in_container(tmp_path):
    """
...
def test_transfer_daemon_unit_integration(tmp_path):
    """
...
def test_transfer_queue_enqueue_then_process(tmp_path):
    """
...
def test_transfer_daemon_no_collect_integration(tmp_path):
    """
