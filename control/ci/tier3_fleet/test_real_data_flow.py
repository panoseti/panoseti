...
Requires:
    ...
    - PCAP file at /app/ci/fixtures/data/*.pcapng inside daqnode
...
class TestRealDataFlow:
    ...
    def test_hashpipe_writes_data_dirs(self, hashpipe_pcap_session, daq_data_dir) -> None:
        """
    ...
    def test_real_stream_delivers_frames(self, hashpipe_pcap_session, real_daq_data_client) -> None:
        """
    ...
    def test_frame_is_dict(self, hashpipe_pcap_session, real_daq_data_client) -> None:
