...
Example:
    python3 permanent_focus_reading.py \
        --config ~/panoseti_mount/panoseti/control/daemons/capture_focus/focus_state_gather_config.json
...
DEFAULT_CONFIG = os.path.expanduser(
    "~/panoseti_mount/panoseti/control/daemons/capture_focus/focus_state_gather_config.json"
)
