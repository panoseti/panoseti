...
from control.utils import image_quantiles as image_quantiles
...
class TestGetValues:
    def test_returns_correct_number_of_values(self, tmp_path) -> None:
    ...
    def test_respects_nframes_limit(self, tmp_path) -> None:
    ...
    def test_all_values_match_fill(self, tmp_path) -> None:
    ...
    def test_mixed_pixel_values(self, tmp_path) -> None:
...
class TestGetQuantiles:
    def test_uniform_image_quantiles(self, tmp_path) -> None:
    ...
    def test_quantile_ordering(self, tmp_path) -> None:
    ...
    def test_x_equals_zero_raises_index_error(self, tmp_path) -> None:
    ...
    def test_x_equals_0_01(self, tmp_path) -> None:
    ...
    def test_x_equals_0_5_returns_median(self, tmp_path) -> None:
    ...
    def test_two_frames(self, tmp_path) -> None:
    ...
    def test_returns_list_of_two(self, tmp_path) -> None:
