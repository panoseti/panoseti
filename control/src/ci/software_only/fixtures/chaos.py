...
class NetemHandle:
    ...
    def latency(
        ...
        from ci.software_only.fixtures.chaos import netem
...
class IptablesHandle:
    ...
    def blocked_egress(
        ...
        from ci.software_only.fixtures.chaos import iptables
...
class DiskHandle:
    ...
    def full_disk(
        ...
        from ci.software_only.fixtures.chaos import disk_chaos
...
class ProcessHandle:
    ...
    def kill(
        ...
        from ci.software_only.fixtures.chaos import process_chaos
...
class GrpcHandle:
    ...
    def proxy(self, client: Any | None = None) -> Any:
        ...
        from ci.software_only.fixtures.chaos.grpc_proxy import GrpcChaosProxy
    ...
    def inject(
        ...
        """
        from ci.software_only.fixtures.chaos.grpc_proxy import inject_rpc_fault
