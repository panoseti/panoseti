...
from ci.software_only.infra.spec import FleetSpec, Topology
from ci.software_only.infra.workspace import StateProbe, Workspace
...
def _setup_workspace(
    ...
    from ci.software_only.infra.materialize import write_all
