...
class NetemHandle:
    ...
    def latency(
        ...
        from ci.fixtures.chaos import netem
...
class IptablesHandle:
    ...
    def blocked_egress(
        ...
        from ci.fixtures.chaos import iptables
...
class DiskHandle:
    ...
    def full_disk(
        ...
        from ci.fixtures.chaos import disk_chaos
...
class GrpcHandle:
    ...
    def proxy(self, client: Any | None = None) -> Any:
        ...
        from ci.fixtures.chaos.grpc_proxy import GrpcChaosProxy
    ...
    def inject(
        ...
        """
        from ci.fixtures.chaos.grpc_proxy import inject_rpc_fault
