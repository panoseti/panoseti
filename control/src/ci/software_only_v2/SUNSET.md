...
- [ ] All v1 tier{1..5} tests appear in `parity_coverage_report()` (run: `python -c "from ci.software_only_v2.infra.parity import parity_coverage_report; print(parity_coverage_report())"`)
...
### 3. Delete the original chaos modules (now in software_only_v2/fixtures/chaos/)
