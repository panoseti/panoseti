...
class TestHashpipeLogs:
    ...
    def test_startdaq_log_arrives_in_loki(self, daq_control_direct, run_params, ensure_clean_daq_state) -> None:
    ...
    def test_log_entry_contains_run_dir(self, daq_control_direct, run_params, ensure_clean_daq_state) -> None:
