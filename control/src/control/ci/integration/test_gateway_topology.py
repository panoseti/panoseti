...
class TestGatewayForwarding:
    ...
    def test_gateway_client_starts_daq(self, daq_control_gateway, run_params, ensure_clean_daq_state) -> None:
        """DaqControlClient via socat gateway can issue StartDaq successfully."""
        ok = daq_control_gateway.StartDaq(run_params)
        assert ok is True

    def test_gateway_client_reports_running(self, daq_control_gateway, run_params, ensure_clean_daq_state) -> None:
    ...
    def test_gateway_double_start_rejected(self, daq_control_gateway, run_params, ensure_clean_daq_state) -> None:
    ...
    def test_gateway_cleanup_after_stop(self, daq_control_gateway, run_params, ensure_clean_daq_state) -> None:
