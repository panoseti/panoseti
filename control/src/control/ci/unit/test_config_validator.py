...
class TestPrintCompactConfig:
    def test_daq_with_many_module_ids_compressed(self, capsys) -> None:
    ...
    def test_daq_with_few_module_ids_not_compressed(self, capsys) -> None:
    ...
    def test_non_daq_config_printed(self, capsys) -> None:
...
class TestPerformNetworkPingSweep:
    def test_all_hosts_up_returns_true(self) -> None:
    ...
    def test_one_host_down_returns_false(self) -> None:
    ...
    def test_head_node_is_checked(self) -> None:
    ...
    def test_head_node_container_skips_head_check(self) -> None:
    ...
    def test_wps_url_is_checked(self) -> None:
    ...
    def test_module_ip_is_checked(self) -> None:
    ...
    def test_no_modules_or_wps_still_returns(self) -> None:
    ...
    def test_gateway_forwarded_module_uses_gw_ip(self) -> None:
