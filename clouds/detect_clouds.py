...
"""
Control routine for cloud detection data pipeline.
TODO: replace references to birdie injection program (copied for development convenience).
"""
import sys
import os
import shutil
...
RUN = 'obs_Lick.start_2023-07-19T06/07/34Z.runtype_sci-obs.pffd'
#RUN = 'obs_Lick.start_2022-10-13T00:08:12Z.runtype_eng.pffd'

if __name__ == '__main__':
    sys.argv = ['detect_clouds.py', '--vol', DATA_DIR, '--run', RUN, '--seconds', '10']
    main()
